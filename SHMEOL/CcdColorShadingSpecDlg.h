...
class CCcdColorShadingSpecDlg : public CDialogEx
{
	DECLARE_DYNAMIC(CCcdColorShadingSpecDlg)

public:
	CCcdColorShadingSpecDlg(CWnd* pParent = NULL);   // 표준 생성자입니다.
	virtual ~CCcdColorShadingSpecDlg();

// 대화 상자 데이터입니다.
	enum { IDD = IDD_DIALOG_CCD_COLOR_SHADING_SPEC};
...
private:
	...
	CGridCtrl m_clGridColorShadingSpec;
