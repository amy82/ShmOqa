...
#define POWER_LKAS_CH1				1
#define POWER_LKAS_CH2				2
#define POWER_LKAS_CH3				3
#define POWER_LKAS_CH4				4
#define POWER_LKAS_LED				5
...
public:
	...
	void SetSize(int nSizeX, int nSizeY) { m_iWidth = nSizeX; m_iHeight = nSizeY; }
	// PCIe
	...
	int CM_SetVoltage_LKAS			(int iChannel, float fVoltage) ;	// voltage set range : 1.0 ~ 5.0V
	...
	int CM_WriteI2C_dv				(int nRegAddrSize, int nDataSize, int nSlaveAddr, int nRegAddr, int *pData, int nDataLength, int ch) ;	
	int CM_ReadI2C_dv				(int nRegAddrSize, int nDataSize, int nSlaveAddr, int nRegAddr, int *pData, int nDataLength, int ch) ;
	int CM_SetI2CData_dv			(int nRegAddr, int nData, int ch) ;
	int CM_SetI2CCommand_dv			(int nCmdType, int nThreadId, bool bIsRead, int nRegAddrSize, int nDataSize, int nSlaveAddr, int nDataLength, int ch) ;

	int CM_SetPWI2CData				(int nRegAddr, int nData) ;
	int CM_SetPWI2CCommand			(int nCmdType, int nThreadId, bool bIsRead, int nRegAddrSize, int nDataSize, int nSlaveAddr, int nDataLength) ;
	int CM_GetPWI2CResponse			(int nThreadId, int *pRdDataH, int *pRdDataL) ;
	int CM_WritePWI2C					(int nRegAddrSize, int nDataSize, int nSlaveAddr, int nRegAddr, int pData, int nDataLength) ;
	int CM_ReadPWI2C					(int nRegAddrSize, int nDataSize, int nSlaveAddr, int nRegAddr, int pData, int nDataLength) ;
	...
	int AR0132_ReadOTPM				(unsigned int* Rcvdata) ;	
