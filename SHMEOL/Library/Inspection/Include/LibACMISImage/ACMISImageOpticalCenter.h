...
#include "export.h"
#include <LibACMISImage\ACMISOpticalCenterDef.h>
...
class ACMISIMAGE_API CACMISOpticalCenterCentroid : public CACMISOpticalCenter<TOpticalCenterN>
{
public:
...
class ACMISIMAGE_API CACMISOpticalCenterCentroidG : public CACMISOpticalCenter<TOpticalCenterNG>
{
public:
...
class ACMISIMAGE_API CACMISOpticalCenterCentroidRGB : public CACMISOpticalCenter<TOpticalCenterNRGB>
{
public:
...
class ACMISIMAGE_API CACMISOpticalCenterCentroidY : public CACMISOpticalCenter<TOpticalCenterNY>
{
public:
