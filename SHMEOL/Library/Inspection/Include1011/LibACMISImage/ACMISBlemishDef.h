...
{
public:
	IBlemishMethodCommon() : m_nImageWidth(0), m_nImageHeight(0), m_nUsing8BitOnly(0), m_nPartialDemosaic(0), m_Mask(NULL), m_nUsingMask(0) { memset(&m_tDataSpec, 0, sizeof(TDATASPEC)); memset(&m_stSpec, 0, sizeof(T)); memset(&m_stCircleData, 0, sizeof(TCircleData)); memset(&m_tBorderLine, 0, sizeof(RECT)); memset(&m_tInspectRegionOffset, 0, sizeof(TInspectRegionOffset)); m_eSaturationMethod = SaturationMethod_Y; }
