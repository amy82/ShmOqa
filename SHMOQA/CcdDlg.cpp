...
void CCcdDlg::OnBnClickedButtonCcdSfrInsp()
{
	...
	//g_clApsInsp[m_nUnit].func_Insp_RotateTilt(g_clLaonGrabberWrapper[m_nUnit].m_pFrameRawBuffer, true);

	//g_clApsInsp[m_nUnit].Func_FinalImageSave(g_clLaonGrabberWrapper[m_nUnit].m_pFrameRawBuffer);		//230428 chart jpg 이미지에 roi,sfr 값남기기


	//g_clApsInsp[m_nUnit].Func_FinalImageSave(g_clLaonGrabberWrapper[m_nUnit].m_pFrameRawBuffer, 0, false);
...
void CCcdDlg::OnBnClickedButtonCcdPixelDefect()
{
	...
	/*if (g_clApsInsp[m_nUnit].func_Insp_Defect(g_clLaonGrabberWrapper[m_nUnit].vDefectLowBuffer, g_clLaonGrabberWrapper[m_nUnit].vDefectMidBuffer_5000k, false) == false)
	{
...
void CCcdDlg::OnBnClickedButtonCcdStain()
{
	...
	g_clApsInsp[m_nUnit].LCBInsp((BYTE*)g_clLaonGrabberWrapper[m_nUnit].m_pFrameRawBuffer);

	g_clApsInsp[m_nUnit].FDFInsp((BYTE*)g_clLaonGrabberWrapper[m_nUnit].m_pFrameRawBuffer);

	g_clApsInsp[m_nUnit].Blemish_YmeanInsp((BYTE*)g_clLaonGrabberWrapper[m_nUnit].m_pFrameRawBuffer);
...
void CCcdDlg::OnBnClickedButtonCcdUniformity()
{
	...
	//if (g_clApsInsp[m_nUnit].func_Insp_Uniformity(g_clLaonGrabberWrapper[m_nUnit].m_pFrameRawBuffer, MID_5000k_RAW, false) == false)//MID_5000k_RAW, LOW_LEVEL_RAW 
	//{
...
void CCcdDlg::OnBnClickedButtonCcdCurrent()
{
	...
	//if (g_clApsInsp[m_nUnit].func_Insp_CurrentMeasure(true, false) == false)
	//if (g_clApsInsp[m_nUnit].func_Insp_Ultra_CurrentMeasure(true, false) == false)
	//if(g_pCarAABonderDlg->CurrentInsp() == false)
	if (g_clApsInsp[m_nUnit].func_Insp_CurrentMeasure(true) == false)
	{
...
#endif
	nRetVal = g_clApsInsp[m_nUnit].func_Insp_ErrorFlag_Read(false);
...
#endif
	nRetVal = g_clApsInsp[m_nUnit].func_Insp_Test_SensorRead(false);
...
void CCcdDlg::OnBnClickedButton2()
{
	...
	//g_clApsInsp[m_nUnit].func_Insp_OpenStainLGIT(g_clLaonGrabberWrapper[m_nUnit].m_pImgBuff12Bit, false);
...
#endif
	nRetVal = g_clApsInsp[m_nUnit].func_Insp_Version_Read(false);
...
void CCcdDlg::OnBnClickedButtonCcdOpticalCenter()
{
	...
	g_clVision.ClearOverlay(m_nUnit);
	/*if (g_clApsInsp[m_nUnit].func_Insp_Ic(g_clLaonGrabberWrapper[m_nUnit].m_pFrameRawBuffer) > 0)
	{
...
void CCcdDlg::OnBnClickedButtonCcdRcbc()
{
	...
	//MID_5000k_RAW
	//LOW_LEVEL_RAW
    if (g_clApsInsp[m_nUnit].func_Insp_WhiteBalance(g_clLaonGrabberWrapper[m_nUnit].m_pFrameRawBuffer, MID_3000K_RAW, false) == false)	//LOW_LEVEL_RAW, MID_3000K_RAW, MID_5000k_RAW  
    {
...
void CCcdDlg::OnBnClickedButtonCcdSnr()
{
  ...
  //  if (g_clApsInsp[m_nUnit].func_Insp_SnrRowColNoise(g_clLaonGrabberWrapper[m_nUnit].m_pFrameRawBuffer, MID_5000k_RAW, false) == false)	//MID_5000k_RAW LOW_LEVEL_RAW 
  //  {
...
void CCcdDlg::OnBnClickedButtonCcdDefectRi()
{
	...
	if (g_clApsInsp[m_nUnit].func_Insp_Shm_Illumination(g_clLaonGrabberWrapper[m_nUnit].m_pFrameRawBuffer, false) == false)
	{
...
void CCcdDlg::OnBnClickedButtonCcdDis()
{
    ...
    //광각 fov는 원형마크로 측정 
    /*if (g_clApsInsp[m_nUnit].func_Insp_Fov_Distortion_Rotate(g_clLaonGrabberWrapper[m_nUnit].m_pFrameRawBuffer, DOT_TYPE, false , true) == false)
    {
...
void CCcdDlg::OnBnClickedButtonCcdCalibration1()
{
	...
	if (g_clApsInsp[m_nUnit].func_CalibrateImageEmbedded(g_clTaskWork[m_nUnit].m_szImagePath, sResult) > 0)
	{
...
void CCcdDlg::OnBnClickedButtonCcdCalibration2()
{
	...
	if (g_clApsInsp[m_nUnit].func_EvaluateUndistortImage(g_clTaskWork[m_nUnit].m_szImagePath, sResult) > 0)
	{
	...
	if (g_clApsInsp[m_nUnit].func_EvaluateDefault(g_clTaskWork[m_nUnit].m_szImagePath, sResult) > 0)
	{
...
void CCcdDlg::OnBnClickedButtonCcdSaturation()
{
	...
	//g_clVision.ClearOverlay(m_nUnit);
	//if (g_clApsInsp[m_nUnit].func_Insp_Saturation(g_clLaonGrabberWrapper[m_nUnit].m_pFrameRawBuffer) == false)	//이물 광원 밝기 검사
	//{
...
void CCcdDlg::OnBnClickedButtonCcdIrFilterTest()
{
	...
	g_clVision.ClearOverlay(m_nUnit);
	g_clApsInsp[m_nUnit].func_Insp_LightTest(0 , false);


	AddLog(_T("[수동검사] CHART BRIGHT 검사 완료"), 0, m_nUnit);
	//if (g_clApsInsp[m_nUnit].func_Insp_IRFilterTest(g_clLaonGrabberWrapper[m_nUnit].m_pFrameRawBuffer) == false)	//이물 광원 밝기 검사
	//{
...
void CCcdDlg::OnBnClickedButtonCcdColorReproduction()
{
	...
	g_clVision.ClearOverlay(m_nUnit);
	//if (g_clApsInsp[m_nUnit].func_Insp_Color_reproduction(g_clLaonGrabberWrapper[m_nUnit].m_pFrameRawBuffer) == false)	//
	//{
	//	AddLog(_T("[수동검사] COLOR REPRODUCTION 검사 실패"), 1, m_nUnit);
	//	return;
	//}
	g_clApsInsp[m_nUnit].func_Insp_Color_reproduction(g_clLaonGrabberWrapper[m_nUnit].m_pFrameRawBuffer);
...
void CCcdDlg::OnBnClickedButtonCcdTemperature()
{
	...
	if (g_clApsInsp[m_nUnit].func_Insp_Temperature(false) == false)
	{ 
...
#endif
	nRetVal = g_clApsInsp[m_nUnit].func_Insp_Supply_Voltage_Read(false);
...
#endif
	nRetVal = g_clApsInsp[m_nUnit].func_EEprom_CheckSum_Check(false);
	if (nRetVal == true)
	{
		//
...
void CCcdDlg::OnBnClickedButtonCcdFpnSpec()
{
	...
	g_clVision.ClearOverlay(m_nUnit);
	g_clApsInsp[m_nUnit].func_Insp_LightTest(1 , false);
...
void CCcdDlg::OnBnClickedButtonCcdDefectRi3()
{
	...
	if (g_clApsInsp[m_nUnit].func_Insp_ColorShading(g_clLaonGrabberWrapper[m_nUnit].m_pFrameRawBuffer, LOW_LEVEL_RAW, false) == false)//MID_5000k_RAW, LOW_LEVEL_RAW
	{
		//AddLog(_T("[수동검사] Relative Illumination 검사 실패"), 1, m_nUnit);
	}
	g_clVision.DrawOverlayAll(m_nUnit);
...
void CCcdDlg::OnBnClickedButtonCcdSnr2()
{
	...
	g_clVision.ClearOverlay(m_nUnit);
	//FPN,5000K 영상으로 nPatternType 변경 3회 측정 , Dark 영상으로 nPatternType 변경  3회 측정
	//if (g_clApsInsp[m_nUnit].func_Insp_SnrRowColNoise(g_clLaonGrabberWrapper[m_nUnit].m_pFrameRawBuffer, LOW_LEVEL_RAW, false) == false)	//MID_5000k_RAW LOW_LEVEL_RAW 
	//{
...
void CCcdDlg::OnBnClickedButtonCcdColorSensitivity2()
{
	...
	//MID_5000k_RAW
	//LOW_LEVEL_RAW
	if (g_clApsInsp[m_nUnit].func_Insp_WhiteBalance(g_clLaonGrabberWrapper[m_nUnit].m_pFrameRawBuffer, MID_5000k_RAW, false) == false)	//LOW_LEVEL_RAW, MID_3000K_RAW, MID_5000k_RAW  
	{
...
void CCcdDlg::OnBnClickedButtonCcdColorSensitivity3()
{
	...
	//MID_5000k_RAW
	//LOW_LEVEL_RAW
	if (g_clApsInsp[m_nUnit].func_Insp_WhiteBalance(g_clLaonGrabberWrapper[m_nUnit].m_pFrameRawBuffer, LOW_LEVEL_RAW, false) == false)	//LOW_LEVEL_RAW, MID_3000K_RAW, MID_5000k_RAW  
	{
...
void CCcdDlg::OnBnClickedButtonCcdLensShading2()
{
	...
	if (g_clApsInsp[m_nUnit].func_Insp_LensShading(g_clLaonGrabberWrapper[m_nUnit].m_pFrameRawBuffer, MID_5000k_RAW, false) == false)	//MID_3000K_RAW, MID_5000k_RAW
	{
...
#endif
	nRetVal = g_clApsInsp[m_nUnit].func_Insp_Sensor_Voltage_Read(false);
