...
class ACMISNOISE_API CACMISSignalNoiseRatioNorm : public CACMISSignalNoiseRatio<TSNRNormSpecN, TSNRNormResult>
{
public:
...
class ACMISNOISE_API CACMISPatternNoise : public CACMISSignalNoiseRatio<TPatternNoiseSpecN, TPatternNoiseResult>
{
public:
	CACMISPatternNoise();
	~CACMISPatternNoise();
...
class ACMISNOISE_API CACMISSignalNoiseRatioBW : public CACMISSignalNoiseRatio<TSNRBWSpecN, TSNRBWResult>
{
public:
...
class ACMISNOISE_API CACMISDarkCurrent : public CACMISSignalNoiseRatio<TDarkCurrentSpec, TDarkCurrentResult>
{
...
class ACMISNOISE_API CACMISSignalNoiseRatioVNE : public CACMISSignalNoiseRatio<TSNRVNESpec, TSNRVNEResult>
{
...
class ACMISNOISE_API CACMISDarkNoise : public CACMISSignalNoiseRatio<TDarkNoiseSpec, TDarkNoiseResult>
{
