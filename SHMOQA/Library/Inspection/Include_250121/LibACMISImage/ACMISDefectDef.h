...
{
public:
	IDefectMethodCommon() : m_nImageWidth(0), m_nImageHeight(0), m_nUsing8BitOnly(0), m_nPartialDemosaic(0), m_nRadX(0), m_nRadY(0), m_dRad(0.0), m_Mask(NULL), m_nUsingMask(0), m_eSaturationMethod(SaturationMethod_Y)
...
{
public:
	IDefectMethodCommonM() : m_nImageWidth(0), m_nImageHeight(0), m_nUsing8BitOnly(0), m_nPartialDemosaic(0), m_nRadX(0), m_nRadY(0), m_dRad(0.0), m_Mask(NULL), m_nUsingMask(0), m_eSaturationMethod(SaturationMethod_Y)
							{ memset(&m_tDataSpec, 0, sizeof(TDATASPEC)); memset(&m_stSpec, 0, sizeof(T)); memset(&m_stCircleData, 0, sizeof(TCircleData)); memset(&m_stCircleSpec, 0, sizeof(TCircleSpecN)); memset(&m_stDefectOffset, 0, sizeof(TDefectOffset)); memset(&m_tInspectRegionOffset, 0, sizeof(TInspectRegionOffset)); }
