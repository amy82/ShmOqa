...
public:
	...
	BOOL SetRowHeightSelect(int iSRow, int iERow, int height);
	int  GetColumnWidth(int nCol) const;
	BOOL SetColumnWidth(int col, int width);
	BOOL SetColumnWidthSelect(int iSCol, int iECol, int iwidth);
...
public:
	...
	BOOL   SetItemText(int nRow, int nCol, double dVal, int iDecimal=0);
	BOOL   SetItemText(int nRow, int nCol, int iVal);
	...
	BOOL   SetItemFormatRow(int nRow, UINT nFormat);
	BOOL   SetItemFormatCol(int nCol, UINT nFormat);
