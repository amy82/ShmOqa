...
void CGridCellCheck::OnClick(CPoint PointCellRelative)
{
	...
	//if (GetCheckPlacement().PtInRect(PointCellRelative))	//작은 Size Check Box 사용시
	if( m_Rect.PtInRect(PointCellRelative) )
	{
